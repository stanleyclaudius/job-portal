    ...
    <div className='bg-white rounded-md border border-gray-200 shadow-md p-5'>
      <div className='flex items-center gap-4'>
        ...
        <div>
          ...
          <p className='text-sm text-gray-700 mt-2'>Jawa Tengah</p>
        </div>
      </div>
      <div className='flex items-center gap-3 mt-6'>
        <p className='text-sm bg-gray-200 w-fit rounded-full px-4 py-1 text-gray-600 truncate'>F&B Industry</p>
        <p className='text-sm bg-gray-200 w-fit rounded-full px-4 py-1 text-gray-600 truncate'>Nedium ENterprise</p>
      </div>
      ...
      <div className='flex items-center justify-between mt-5'>
        <button className='bg-blue-500 hover:bg-blue-600 transition-[background] rounded-md text-white px-4 py-2 text-sm'>Detail</button>
