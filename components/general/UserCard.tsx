...
const UserCard = () => {
  ...
  return (
    <>
      <div onClick={() => setOpenUserDescriptionModal(true)} className='bg-white rounded-md border border-gray-200 shadow-md p-5 cursor-pointer hover:scale-105 transition-[transform]'>
