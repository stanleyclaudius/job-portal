  ...
  return (
    <div className='pb-20 pt-14 px-10 md:px-0'>
      ...
      <div className='w-full max-w-[800px] m-auto bg-white shadow-xl border border-gray-200 md:rounded-full rounded-md md:h-16 h-auto md:py-0 py-6 px-4 mt-12'>
        <form className='flex md:flex-row flex-col items-center h-full gap-3'>
          <div className='flex items-center gap-3 md:mb-0 mb-5 md:border-none border-b border-gray-200 md:pb-0 pb-3'>
          ...
          <div className='flex items-center gap-3 md:mb-0 mb-4 md:border-none border-b border-gray-200 md:pb-0 pb-3'>
